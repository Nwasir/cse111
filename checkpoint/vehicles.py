def main():
    ...
    if vin in vehicles_dict:
        ...
        manufacturer_name = value[MANUFACTURER_INDEX]
        vehicle_model = value[MODEL_INDEX]
        vehicle_color = value[COLOR_INDEX]
        vehicle_design = value[ENG_DESIGN]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"{manufacturer_name} {vehicle_model} {vehicle_color} {vehicle_design}")
